...
public class CurrentConfigComponent extends HUDContainer {
    public CurrentConfigComponent(int x, int y, int width, int height) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        width = Minecraft.getMinecraft().fontRenderer.getStringWidth("Current Config: " + ConfigManager.currentConfig);
        height = Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT;
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("Current Config" + ChatFormatting.GRAY + ": " + ChatFormatting.WHITE + ConfigManager.currentConfig, x, y, color.getRGB());
    }
