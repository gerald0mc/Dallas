...
public class TotemCountComponent extends HUDContainer {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("Totems" + ChatFormatting.GRAY + ": " + ChatFormatting.WHITE + InventoryUtil.getTotalAmountOfItem(Items.TOTEM_OF_UNDYING), this.x, this.y, new Color(Yeehaw.INSTANCE.moduleManager.getModule(GUI.class).red.getValue() / 255f, Yeehaw.INSTANCE.moduleManager.getModule(GUI.class).green.getValue() / 255f, Yeehaw.INSTANCE.moduleManager.getModule(GUI.class).blue.getValue() / 255f).getRGB());
    }
