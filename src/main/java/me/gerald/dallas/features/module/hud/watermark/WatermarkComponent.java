...
public class WatermarkComponent extends HUDContainer {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(Yeehaw.MOD_NAME + " " + ChatFormatting.WHITE + Yeehaw.VERSION, x, y, new Color(Yeehaw.INSTANCE.moduleManager.getModule(GUI.class).color.getR() / 255f, Yeehaw.INSTANCE.moduleManager.getModule(GUI.class).color.getG() / 255f, Yeehaw.INSTANCE.moduleManager.getModule(GUI.class).color.getB() / 255f).getRGB());
    }
