...
public class FPSComponent extends HUDContainer {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        width = Minecraft.getMinecraft().fontRenderer.getStringWidth("FPS: " + Yeehaw.INSTANCE.fpsManager.getFPS());
        height = Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT;
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("FPS" + ChatFormatting.GRAY + ": " + ChatFormatting.WHITE + Yeehaw.INSTANCE.fpsManager.getFPS(), x, y, color.getRGB());
    }
